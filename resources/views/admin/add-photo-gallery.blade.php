    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget box">
                <div class="widget-header"><h4><i class="fa fa-plus-square"></i> Add Photo</h4> </div>
                <div class="widget-content">
                    <div class="col-xs-12 col-sm-12">
                      ...
                      {{ Form::open(array('url' => 'add-photo-gallery', 'role' => 'form', 'class' =>'form-horizontal row-border', 'name' => 'frm_gp', 'id' => 'frm_gp','files'=>true, 'autocomplete' => 'off')) }}  
                      
                      <div class="form-group col-md-8">
                        <label>Upload  Photo*:</label> 
                        {!! Form::file('gallery_photo', array('id' => 'gallery_photo','required', 'class'=>'','placeholder'=>'')) !!}
                     ...
                     {!! Form::text('photo_title','',array('id' => 'photo_title','required','class'=>'form-control','placeholder'=>'')) !!}
                     </div>
