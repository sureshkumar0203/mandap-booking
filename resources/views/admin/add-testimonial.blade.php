    ...
    <div class="row">
        <div class="col-md-12">
            <div class="widget box">
                <div class="widget-header"><h4><i class="fa fa-plus-square"></i> Add Testimonial</h4> </div>
                <div class="widget-content">
                    <div class="col-xs-12 col-sm-12">
                      ...
                      {{ Form::open(array('url' => 'add-testimonial', 'role' => 'form', 'class' =>'form-horizontal row-border', 'name' => 'frm_tm', 'id' => 'frm_tm','files'=>true, 'autocomplete' => 'off')) }}  
                      
                      <div class="form-group col-md-8">
                      <label>User Name*:</label> 
                     {!! Form::text('tm_user_name','',array('id' => 'tm_user_name','required','class'=>'form-control','placeholder'=>'')) !!}
                      </div>
                      
                      <div class="form-group col-md-8">
                        <label>Details*:</label>
                        {!! Form::textarea('tm_det','', array('id' => 'tm_det','required', 'class'=>'form-control','placeholder'=>'','size' => '100x5')) !!}
                      </div>
