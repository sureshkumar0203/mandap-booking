...
$(document).ready(function() {
        ...
        $.get('data.txt', function(data) {
            ...
            for (var i = 0; i < arrayOfNames.length; i++) {
                ...
                $('.owl-carousel').append('' +
                    ...
                    '<a class="pan-menu-item"  id="pan-image-' + dataHash + '" data-pan-href="' + arrayOfNames[i][2] + '" href="#' + dataHash + '">' +
                    '<img class="pan-slide-thumb" src="images/' + arrayOfNames[i][2] + '">' +
                    /*arrayOfNames[i][0] +*/
                    '</a>' +
                    '</li>' +
                    '</div>');
    ...
    function fullscreenPanorama() {
        $('#fullscreenPan').bind('touchstart click', function() {
            $('#fullscreen-icon').attr("src", sourceUrl + "images/fullscreen.png");
            if ($(document).fullScreen() == false) {
                $('#panorama').fullScreen(true);
                fullscreenMode = true;
                $('#fullScreenMode').addClass('now-full-screen');
                $('#fullscreen-icon').attr("src", sourceUrl + "images/leaveFullScreen.png");
            } else {
